...
export const BasicsPreview: React.FC = () => {
  ...
  const hasPhoto = photo?.url && photo?.visible;
    ...
    >
      <div
        className={cn("flex gap-3", {
          "items-center": alignment === "start",
          "flex-col justify-center items-center": alignment === "center",
          "flex-row-reverse justify-start items-center": alignment === "end",
        })}
      >
        {hasPhoto && (
          <img
        ...
        <div>
          ...
          <div style={{ fontSize }} className="clear-both">
            {location.value && (
